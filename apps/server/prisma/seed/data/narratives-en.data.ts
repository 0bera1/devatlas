/** English scenario narratives (markdown). Keys must match Turkish file. */
import type { SeedFlowNarrativeInput } from './narratives-tr.data';

export const diagramNarrativesEn: Readonly<Record<string, string>> = {
