...
exports.seedFlows = void 0;
exports.seedFlows = [
    {
        slug: 'full-stack-request-journey',
        title: 'Full-Stack Request Journey',
        description: '3 ayrı diyagram · sırayla: istek yolu → mikroservisler → veritabanı ölçekleme',
        sortOrder: 1,
        steps: [
    ...
    },
    {
        ...
        description: '2 ayrı diyagram · sırayla: kimlik/token (Auth) → build & deploy (CI/CD)',
        sortOrder: 2,
        steps: [
    ...
    },
    {
        ...
        description: '3 ayrı diyagram · sırayla: React katmanları → state → micro frontend',
        sortOrder: 3,
        steps: [
...
//# sourceMappingURL=flows.data.js.map