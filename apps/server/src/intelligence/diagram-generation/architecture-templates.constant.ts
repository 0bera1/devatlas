...
/**
 * Heuristic diagram üretimi için sabit mimari şablon kayıtları.
 *
 * - Anahtarlar normalize formatta (lowercase). Matcher prompt'u tarayıp
 *   en çok eşleşen şablonu seçer.
 * - Koordinatlar 240×120'lik basit bir grid içinde; editörün spread görünümüne uyumlu.
 * - LLM entegrasyonu eklendiğinde bu sabit registry fallback olarak kalır.
 */
...
/** Hiç eşleşme yoksa kullanılacak güvenli varsayılan. */
export const ARCHITECTURE_TEMPLATE_FALLBACK_ID = 'rest-api';

export const ARCHITECTURE_TEMPLATE_MIN_PROMPT_LENGTH = 1;
export const ARCHITECTURE_TEMPLATE_MAX_PROMPT_LENGTH = 500;
