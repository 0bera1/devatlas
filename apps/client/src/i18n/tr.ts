export const trMessages = {
  ...
  'auth.validation.firstNameRequired': 'Ad zorunludur.',
  'auth.validation.lastNameRequired': 'Soyad zorunludur.',
  ...
  'knowledge.section.diagrams': 'Diyagramlar',
  'knowledge.section.flows': 'Akışlar',
  'knowledge.readOnly': 'Salt okunur',
  'knowledge.backToBase': '← Bilgi tabanı',
  'knowledge.interview.comingSoonTitle': 'Mülakata hazırlan',
  'knowledge.interview.comingSoonBody':
    'Bu bölüm bir sonraki adımda eklenecek. Şimdilik doküman ve diyagramları inceleyebilirsiniz.',
  'knowledge.documents.empty': 'Henüz sistem dokümanı yok.',
  'knowledge.document.notFound': 'Doküman bulunamadı.',
  'knowledge.diagrams.heading': 'Diyagramlar',
  'knowledge.diagrams.empty': 'Henüz sistem diyagramı yok.',
  'knowledge.diagrams.nodesLabel': 'düğüm',
  'knowledge.diagram.notFound': 'Diyagram bulunamadı.',
  'knowledge.flows.heading': 'Akışlar (Flow)',
  'knowledge.flows.empty': 'Henüz sistem akışı yok.',
  'knowledge.flows.stepsLabel': 'adım',
  'knowledge.flow.notFound': 'Akış bulunamadı.',
  'knowledge.flow.stepsLabel': 'adım',
  'knowledge.flow.howToRead':
    'Bu akış, birden fazla diyagramı sırayla okumanız için tasarlandı. Her adımda ilgili diyagram ve adım anlatımı gösterilir.',
  'knowledge.flow.stepsHeading': 'Akış adımları',
  'knowledge.flow.diagramRef': 'Diyagram',
  'knowledge.flow.openDiagramOnly': 'Yalnızca diyagram sayfasını aç',
  'knowledge.flow.prev': 'Önceki adım',
  'knowledge.flow.next': 'Sonraki adım',
  'knowledge.narrative.ariaLabel': 'Adım adım anlatım',
  'knowledge.narrative.heading': 'Adım adım anlatım',
  'knowledge.narrative.badge': 'Senaryo',
  ...
  'profile.info.description':
    'E-posta sabit kalır; ad, soyad ve doğum tarihini güncelleyebilirsin.',
  'profile.info.email': 'E-posta',
  'profile.info.firstName': 'Ad',
  'profile.info.lastName': 'Soyad',
  'profile.info.firstNamePlaceholder': 'Adınız',
  'profile.info.lastNamePlaceholder': 'Soyadınız',
